...
public class ObjectConnect extends Application {
  ...
  @Override public void start(final Stage stage) throws Exception {
    ...
    Anchor target   = new Anchor(Color.RED, new SimpleDoubleProperty(50), new SimpleDoubleProperty(50));
    ...
    stage.setScene(new Scene(new Group(line, start, end, target ), 400, 400, Color.ALICEBLUE));
    stage.show();
  }

  class BoundLine extends Line {
	 public  StringProperty id = new SimpleStringProperty(UUID.randomUUID().toString());
    ...
    private void enableDrag() {
      ...
      setOnMouseDragged(new EventHandler<MouseEvent>() {
        @Override public void handle(MouseEvent mouseEvent) {
          ...
          System.out.println("Targer= " + mouseEvent.getTarget());
